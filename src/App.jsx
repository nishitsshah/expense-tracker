  ...
  if (!googleToken) {
    return (
      <div style={{ fontFamily:"-apple-system,'SF Pro Display','Helvetica Neue',sans-serif", background:"#F2F2F7", minHeight:"100vh", maxWidth:430, margin:"0 auto", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"40px 32px" }}>
        ...
        <div style={{ fontSize:28, fontWeight:700, marginBottom:8, color:"#1C1C1E", textAlign:"center" }}>Expense Tracker</div>
        <div style={{ fontSize:16, color:"#8E8E93", textAlign:"center", marginBottom:48, lineHeight:1.5 }}>Sign in with Google to sync your data across all devices.</div>
        <button onClick={handleGoogleLogin} style={{ width:"100%", padding:"18px", borderRadius:16, border:"none", cursor:"pointer", background:"#fff", boxShadow:"0 2px 20px rgba(0,0,0,.12)", display:"flex", alignItems:"center", justifyContent:"center", gap:12 }}>
          ...
          <span style={{ fontSize:17, fontWeight:600, color:"#1C1C1E" }}>Sign in with Google</span>
        </button>
        <div style={{ marginTop:24, fontSize:12, color:"#C7C7CC", textAlign:"center" }}>Your data is stored in your own Google Drive.</div>
      </div>
    );
  }
